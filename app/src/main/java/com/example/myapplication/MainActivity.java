        ...
        buttonSubmit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (name.isEmpty()) {
                    ...
                    Toast.makeText(MainActivity.this, "wprowadź nazwisko", Toast.LENGTH_SHORT).show();
                    ...
                    Toast.makeText(MainActivity.this, "wpisz hasło ponownie", Toast.LENGTH_SHORT).show();
